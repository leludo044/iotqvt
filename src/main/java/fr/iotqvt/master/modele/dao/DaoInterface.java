...
public interface DaoInterface<TMetier, TIdMetier> {
	 ...
	 *
	 * @param objet
	 *            métier contenant les données nécessaires à l'ajout
	...
	// /**
	// * retrieveMany
	// * @param objet contenant les critéres de recherche, null si aucun critére
